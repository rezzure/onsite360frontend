    ...
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          ...
          <div className='w-[80%] flex justify-center mb-6 mr-6'>
            <button className='border rounded pt-3 pl-6 pr-6 pb-3 cursor-pointer w-full hover:bg-gray-500 hover:text-white' onClick={handleLogOut}>Logout</button>
          </div>
